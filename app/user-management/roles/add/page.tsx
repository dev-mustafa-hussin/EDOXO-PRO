  ...
  const [permissionSections, setPermissionSections] = useState<PermissionSection[]>([
    ...
    },
    {
      ...
      permissions: [
        ...
        { id: "customer_no_sale_1month", label: "عرض العملاء الذين لم يبيعوا من شهر واحد فقط", checked: false },
        { id: "customer_no_sale_3months", label: "عرض العملاء الذين لم يبيعوا لمدة ثلاثة أشهر فقط", checked: false },
        { id: "customer_no_sale_6months", label: "عرض العملاء الذين لم يبيعوا منذ ستة أشهر فقط", checked: false },
        { id: "customer_no_sale_1year", label: "عرض العملاء الذين لم يبيعوا منذ عام واحد فقط", checked: false },
        { id: "customer_view_regardless", label: "عرض العملاء بغض النظر عن بيعهم", checked: false },
    ...
    },
    {
      ...
      permissions: [
        ...
        { id: "purchases_add_payment", label: "إضافة مدفوعات الشراء", checked: false },
        { id: "purchases_edit_payment", label: "تحرير دفع الشراء", checked: false },
        { id: "purchases_delete_payment", label: "حذف دفعة الشراء", checked: false },
        { id: "purchases_update_status", label: "تحديث حالة الشراء", checked: false },
      ],
    },
    {
      id: "stock_adjustment",
      title: "تعديل المخزون",
      permissions: [
        { id: "stock_adj_view_all", label: "عرض جميع تعديلات المخزون", checked: false },
        { id: "stock_adj_view_own", label: "عرض تعديلات المخزون الخاصة", checked: false },
    ...
    },
    {
      ...
      title: "تحويل المخزون",
      permissions: [
        { id: "stock_transfer_view_all", label: "عرض جميع تحويلات المخزون", checked: false },
        { id: "stock_transfer_view_own", label: "عرض تحويلات المخزون الخاصة", checked: false },
        { id: "stock_transfer_add", label: "إضافة تحويل مخزون", checked: false },
        { id: "stock_transfer_edit", label: "تعديل تحويل مخزون", checked: false },
        { id: "stock_transfer_delete", label: "حذف تحويل مخزون", checked: false },
      ],
    },
    {
      id: "pos",
      ...
      permissions: [
        ...
        { id: "pos_edit_price", label: "تحرير سعر المنتج من شاشة POS", checked: false },
        { id: "pos_edit_discount", label: "تحرير خصم المنتج من شاشة POS", checked: false },
        { id: "pos_add_edit_payment", label: "إضافة/تحرير دفع", checked: false },
        ...
        { id: "pos_disable_express", label: "تعطيل الدفع السريع", checked: false },
        { id: "pos_disable_discount", label: "تعطيل الخصم", checked: false },
        { id: "pos_disable_suspend", label: "تعطيل تعليق البيع", checked: false },
        { id: "pos_disable_credit", label: "تعطيل بيع الرصيد", checked: false },
        { id: "pos_disable_quotation", label: "تعطيل عرض السعر", checked: false },
    ...
    },
    {
      ...
      permissions: [
        ...
        { id: "sales_view_paid", label: "عرض عمليات البيع المدفوعة فقط", checked: false },
        { id: "sales_view_due", label: "عرض البيع المستحق فقط", checked: false },
        { id: "sales_view_partial", label: "عرض عمليات البيع المدفوعة جزئيًا فقط", checked: false },
        { id: "sales_view_overdue", label: "عرض عمليات البيع المتأخرة فقط", checked: false },
        ...
        { id: "sales_commission_view", label: "يمكن لوكيل العمولة عرض بيعه الخاص", checked: false },
        ...
        { id: "sales_edit_price", label: "تعديل سعر المنتج من شاشة البيع", checked: false },
        { id: "sales_edit_discount", label: "تعديل خصم المنتج من شاشة البيع", checked: false },
        { id: "sales_discount_crud", label: "إضافة/تحرير/حذف خصم", checked: false },
        { id: "sales_return_all", label: "الوصول إلى جميع عمليات إعادة البيع", checked: false },
        { id: "sales_return_own", label: "الوصول إلى إعادة البيع الخاصة بالبيع", checked: false },
        { id: "sales_edit_invoice_number", label: "تعديل رقم الفاتورة", checked: false },
      ],
    },
    {
      id: "draft",
    ...
    },
    {
      ...
      title: "عرض سعر",
      permissions: [
        { id: "quotation_view_all", label: "عرض جميع عروض الأسعار", checked: false },
        { id: "quotation_view_own", label: "عرض عروض الأسعار الخاصة", checked: false },
    ...
    },
    {
      ...
      title: "الشحنات",
      permissions: [
        { id: "shipments_view_all", label: "الوصول إلى جميع الشحنات", checked: false },
        { id: "shipments_view_own", label: "الوصول إلى الشحنات الخاصة", checked: false },
        { id: "shipments_pending_only", label: "الوصول إلى الشحنات المعلقة فقط", checked: false },
        { id: "shipments_commission", label: "يمكن للوكيل بالعمولة الوصول إلى الشحنات الخاصة بهم", checked: false },
      ],
    },
    {
      id: "shift",
    ...
    },
    {
      ...
      permissions: [
        ...
        { id: "reports_supplier_customer", label: "عرض تقرير الموردين والعملاء", checked: false },
        ...
        { id: "reports_stock", label: "عرض تقرير المخزون وتعديلاته وتقرير انتهاء الصلاحية", checked: false },
        { id: "reports_trending", label: "عرض تقرير المنتجات الأكثر مبيعاً", checked: false },
        { id: "reports_register", label: "عرض تقرير السجل", checked: false },
        { id: "reports_sales_rep", label: "عرض تقرير مندوبي المبيعات", checked: false },
        { id: "reports_stock_value", label: "عرض قيمة مخزون المنتج", checked: false },
      ],
    },
    {
      id: "settings",
      ...
      permissions: [
        ...
        { id: "settings_barcode", label: "الوصول إلى إعدادات الباركود", checked: false },
    ...
    },
    {
      ...
      title: "مصروف",
      permissions: [
        { id: "expense_view_all", label: "الوصول إلى جميع النفقات", checked: false },
        { id: "expense_view_own", label: "عرض النفقات الخاصة فقط", checked: false },
    ...
    },
    {
      ...
      permissions: [{ id: "selling_default", label: "سعر البيع الافتراضي", checked: false }],
    },
    {
      id: "accounting",
      title: "Accounting",
      permissions: [
        { id: "accounting_access", label: "الوصول إلى قسم المحاسبة", checked: false },
        { id: "accounting_manage", label: "إدارة الحسابات", checked: false },
        { id: "accounting_view_journal", label: "عرض دفتر اليومية", checked: false },
        { id: "accounting_add_journal", label: "اضافة قيد يومية", checked: false },
        { id: "accounting_edit_journal", label: "تعديل قيد يومية", checked: false },
        { id: "accounting_delete_journal", label: "حذف قيد يومية", checked: false },
        { id: "accounting_link_op", label: "ربط العملية", checked: false },
        { id: "accounting_view_transfer", label: "عرض التحويل", checked: false },
        { id: "accounting_add_transfer", label: "اضافة تحويل", checked: false },
        { id: "accounting_edit_transfer", label: "تعديل التحويل", checked: false },
        { id: "accounting_delete_transfer", label: "حذف التحويل", checked: false },
    ...
    },
    {
      ...
      permissions: [
        ...
        { id: "asset_view_all_maintenance", label: "عرض كل الصيانة", checked: false },
        { id: "asset_view_own_maintenance", label: "عرض الصيانة الخاصة بك", checked: false },
      ],
    },
    {
      id: "crm",
      title: "Crm",
      permissions: [
        { id: "crm_all_followups", label: "الوصول إلى جميع المتابعة", checked: false },
        { id: "crm_own_followups", label: "الوصول إلى المتابعة الخاصة", checked: false },
        { id: "crm_all_leads", label: "الوصول إلى جميع العملاء المحتملين", checked: false },
        { id: "crm_own_leads", label: "الوصول إلى العملاء المحتملين الخاص بك", checked: false },
        { id: "crm_all_campaigns", label: "الوصول إلى جميع الحملات", checked: false },
        { id: "crm_own_campaigns", label: "الوصول إلى الحملات الخاصة بك", checked: false },
        { id: "crm_contact_login", label: "الوصول إلى تسجيل الدخول لجهة الاتصال", checked: false },
        { id: "crm_sources", label: "مصادر الوصول", checked: false },
        { id: "crm_life_stage", label: "الوصول إلى مرحلة الحياة", checked: false },
    ...
    },
    {
      ...
      title: "Essentials",
      permissions: [
        { id: "ess_leave_types", label: "إدارة أنواع الإجازات", checked: false },
        { id: "ess_all_leave", label: "إدارة جميع طلبات الإجازات", checked: false },
        { id: "ess_own_leave", label: "إدارة الإجازات الشخصية", checked: false },
        { id: "ess_approve_leave", label: "الموافقة على الإجازة", checked: false },
        { id: "ess_all_attendance", label: "إدارة سجلات الحضور للجميع", checked: false },
        { id: "ess_own_attendance", label: "عرض سجل الحضور الشخصي", checked: false },
        { id: "ess_web_clock", label: "السماح للموظفين بتسجيل الحضور من المتصفح (الويب)", checked: false },
        { id: "ess_api_clock", label: "السماح للموظفين بتسجيل الحضور من التطبيق (API)", checked: false },
        ...
        { id: "ess_designations", label: "إدارة المسميات الوظيفية", checked: false },
        ...
        { id: "ess_assign_task", label: "إسناد المهمة لموظف آخر", checked: false },
        ...
        { id: "ess_sales_targets", label: "وصول إلى أهداف المبيعات", checked: false },
    ...
    },
    {
      ...
      title: "Spreadsheet",
      permissions: [
        { id: "spreadsheet_access", label: "الوصول إلى جدول البيانات", checked: false },
        { id: "spreadsheet_create", label: "إنشاء جدول بيانات", checked: false },
      ],
    },
    {
      id: "superadmin",
      title: "Superadmin",
      permissions: [{ id: "superadmin_subscriptions", label: "اشتراكات حزمة الوصول", checked: false }],
    },
    {
      id: "woocommerce",
      title: "Woocommerce",
      permissions: [
        { id: "woo_sync_categories", label: "فئات منتجات المزامنة", checked: false },
        ...
        { id: "woo_settings", label: "الوصول إلى إعدادات Woocommerce API", checked: false },
      ],
    },
  ])
    ...
    setPermissionSections((prev) =>
      prev.map((section) => {
        if (section.id === sectionId) {
          ...
          return {
            ...section,
            permissions: section.permissions.map((p) => ({ ...p, checked: !allChecked })),
          }
        }
        return section
      }),
    ...
    setPermissionSections((prev) =>
      prev.map((section) => {
        if (section.id === sectionId) {
          return {
            ...section,
            permissions: section.permissions.map((p) => (p.id === permissionId ? { ...p, checked: !p.checked } : p)),
          }
        }
        return section
      }),
        ...
        <main className="flex-1 p-6">
          ...
          <div className="flex items-center justify-between mb-6">
            <div className="flex items-center gap-3">
              ...
              <h1 className="text-xl font-semibold text-gray-800">إضافة صلاحية جديدة</h1>
            </div>
          ...
          <div className="bg-white rounded-lg shadow-sm p-6">
            ...
            <div className="mb-6">
              <h2 className="text-lg font-semibold text-gray-800 border-b pb-3">الأذونات</h2>
            </div>
              ...
              {permissionSections.map((section) => (
                <div key={section.id} className="border rounded-lg overflow-hidden">
                  ...
                  <div className="bg-gray-100 px-4 py-3 flex items-center justify-between">
                    ...
                    <Button variant="outline" size="sm" onClick={() => handleSelectAll(section.id)} className="text-xs">
                      {section.permissions.every((p) => p.checked) ? "إلغاء تحديد الكل" : "تحديد الكل"}
                    </Button>
                  </div>
                    ...
                    {section.permissions.map((permission) => (
                      <div key={permission.id} className="flex items-center gap-2">
                        <Checkbox
                          ...
                          onCheckedChange={() => handlePermissionChange(section.id, permission.id)}
                        />
            ...
            <div className="mt-8 flex justify-end">
              <Button onClick={handleSave} className="bg-blue-600 hover:bg-blue-700 gap-2 px-8" disabled={!roleName}>
